...
class ProjectsIndex extends React.Component {
  render() {
    ...
    return (
      <Wrapper wide>
        <SEO 
        title="Projects - My experiences throughout my career as a marketing consultant" 
        description="Examples of the companies I've helped and the projects I've mastered. From designing websites to starting my own business."
        />
        <Banner>
