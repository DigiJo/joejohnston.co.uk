...
class BlogIndex extends React.Component {
  render() {
    ...
    return (
      <Wrapper>
        <SEO 
        title="Journal - Life, business and marketing lessons" 
        description="I write about my experiences and thoughts as they are 
        and I try and most of the time fail to slap that writing with humour."
        />
        <Banner>
          <Title>Journal</Title>
          <Description>
            Fleeting thoughts go to{' '}
            <a href="//twitter.com/joejohnston1989" target="_blank" rel="nofollow">
              Twitter
